...
!function (e) {
      ...
      _createClass(t, [{
        ...
        value: function applyLoaderTransition() {
          try {
            ...
            console.warn("LoaderTransition could not be applied.\nFollowing error was thrown inside the class: "), console.error(e);
        ...
        value: function styleAjaxLoadsSimple() {
          var e = this;
          void 0 === e.preloader && e._selectPreloader(), $(document).ajaxStart(function (o) {
            e.preloader.fadeIn();
        ...
        value: function styleAjaxLoads(e) {
          console.info("\n\n------ styleAjaxLoads()-----"), console.info("The given parameter is:"), console.info(e);
          var o = this;

          try {
            o._selectAjaxLoader(), e.forEach(function (e) {
              return 0 === e.target.length ? console.log("There is no Element in your target selection: " + e.target) : 0 === e.source.length ? console.log("There is no Element in your source selection: " + e.source) : (e.target.css({
                position: "relative"
              }), void e.source.click(function () {
        ...
        value: function _applyPreLoader() {
          var e = this;
          this._selectPreloader(), $(window).on("load", function () {
            e.preloader.delay(350).fadeOut("slow"), $("body").delay(350).css({
              overflow: "visible"
            });
          });
        }
        ...
        value: function _applyPreCashLoader() {
          var e = this;
          this._selectPrecacheLoader(), this.pageLeaveLinks.click(function () {
        ...
        value: function _applyLoadTransitionBlender() {
          var e = this;
          this._selectBlender(), e.blender.show(), $(window).on("load", function () {
            e.blender.delay(350).fadeOut("slow"), $("body").delay(350).css({
              overflow: "visible"
            });
          }), e.pageLeaveLinks.click(function (o) {
            o.preventDefault();
            var t = $(this).attr("href");
            return e.blender.fadeIn(300, function () {
        ...
        value: function _selectPreloader() {
          var e = this,
            o = $("#LoadStyler_Preloader");
          if (o.length > 0) return e.preloader = o;
          {
            var _o = $('<div id="LoadStyler_Preloader"></div>');

            return $("body").prepend(_o), "auto" === _o.css("z-index") && "fixed" !== _o.css("position") && _o.css({
        ...
        value: function _selectBlender() {
          var e = this,
            o = $("#LoadStyler_Blender");
          return o.length > 0 ? e.blender = o : (o = $('<div id="LoadStyler_Blender"></div>'), $("body").prepend(o), "auto" === o.css("z-index") && "fixed" !== o.css("position") && o.css({
            position: "fixed",
            zIndex: 100,
            width: "100%",
            height: "100%",
        ...
        value: function _selectAjaxLoader() {
          ...
          return o.length > 0 ? e.ajaxloader = o : (o = $('<div id="LoadStyler_AjaxLoader"></div>'), $("body").prepend(o), "auto" === o.css("z-index") && o.css({
        ...
        value: function _selectPrecacheLoader() {
          ...
          return o.length > 0 ? e.preCacheLoader = o : (o = $('<div id="LoadStyler_PrecacheLoader"></div>'), $("body").prepend(o), "auto" === o.css("z-index") && "fixed" !== o.css("position") && o.css({
            border: "16px solid #f3f3f3",
            borderRadius: "50%",
            borderTop: "16px solid #3498db",
            width: "120px",
  ...
  window.LoadStyler = t, e.exports = t;
